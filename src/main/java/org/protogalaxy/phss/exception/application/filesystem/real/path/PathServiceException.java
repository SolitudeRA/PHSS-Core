package org.protogalaxy.phss.exception.application.filesystem.real.path;
...
public class PathServiceException extends RuntimeException {
     ...
     * @since 1.7
     */
    protected PathServiceException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
