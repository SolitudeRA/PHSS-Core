package org.protogalaxy.phss.exception.application.filesystem.real.file;
...
public class FileUtilsException extends RuntimeException {
     ...
     * @since 1.7
     */
    protected FileUtilsException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
