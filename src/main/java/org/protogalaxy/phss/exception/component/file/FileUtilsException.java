...
public class FileUtilsException extends PhssException {
    /**
     ...
     */
    public FileUtilsException(PhssErrorCodeMain errorCode) {
        super(errorCode);
    }
     ...
     */
    public FileUtilsException(PhssErrorCodeMain errorCode, Throwable cause) {
