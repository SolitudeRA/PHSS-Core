...
public class MusicServiceException extends PhssException {
    /**
     ...
     */
    public MusicServiceException(PhssErrorCodeMain errorCode) {
        super(errorCode);
    }
     ...
     */
    public MusicServiceException(PhssErrorCodeMain errorCode, Throwable cause) {
