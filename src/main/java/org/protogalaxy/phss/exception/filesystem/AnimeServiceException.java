...
public class AnimeServiceException extends PhssException {
    /**
     ...
     */
    public AnimeServiceException(PhssErrorCodeMain errorCode) {
        super(errorCode);
    }
     ...
     */
    public AnimeServiceException(PhssErrorCodeMain errorCode, Throwable cause) {
