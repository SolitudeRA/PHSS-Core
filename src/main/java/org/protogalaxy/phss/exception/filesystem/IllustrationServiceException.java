...
public class IllustrationServiceException extends RuntimeException {
    /**
     ...
     */
    public IllustrationServiceException(PhssErrorCodeMain errorCode) {
        super(errorCode);
    }
     ...
     */
    public IllustrationServiceException(PhssErrorCodeMain errorCode, Throwable cause) {
