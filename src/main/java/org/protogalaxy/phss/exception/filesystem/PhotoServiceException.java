...
public class PhotoServiceException extends PhssException {
    /**
     ...
     */
    public PhotoServiceException(PhssErrorCodeMain errorCode) {
        super(errorCode);
    }
     ...
     */
    public PhotoServiceException(PhssErrorCodeMain errorCode, Throwable cause) {
