...
public class VideoServiceException extends PhssException {
    /**
     ...
     */
    public VideoServiceException(PhssErrorCodeMain errorCode) {
        super(errorCode);
    }
     ...
     */
    public VideoServiceException(PhssErrorCodeMain errorCode, Throwable cause) {
