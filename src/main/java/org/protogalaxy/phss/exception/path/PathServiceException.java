...
public class PathServiceException extends PhssException {
    /**
     ...
     */
    public PathServiceException(PhssErrorCodeMain errorCode) {
        super(errorCode);
    }
     ...
     */
    public PathServiceException(PhssErrorCodeMain errorCode, Throwable cause) {
